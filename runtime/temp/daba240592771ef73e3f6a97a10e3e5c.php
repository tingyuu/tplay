<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\phpStudy\WWW\tplay\public/../application/admin\view\menu\index.html";i:1513408352;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-btn-group demoTable">
  <a href="<?php echo url('admin/menu/publish'); ?>" class="a_menu">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="operation-menu">
        <a href="<?php echo url('admin/menu/publish',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-xs a_menu"><i class="layui-icon"></i></a>
        <a href="<?php echo url('admin/menu/publish',['pid'=>$vo['id']]); ?>" class="layui-btn layui-btn-xs a_menu"><i class="layui-icon"></i></a>
        <a href="javascript:;" class="layui-btn layui-btn-xs delete" id="<?php echo $vo['id']; ?>"><i class="layui-icon"></i></a>
      </td>
    </tr>
