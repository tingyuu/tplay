<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\phpStudy\WWW\tplay\public/../application/admin\view\common\login.html";i:1513924611;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
                    ...
                    <div class="kit-login-main">
                        <form class="layui-form" id="login">
                            ...
                            <div class="layui-form-item">
                                ...
                                <input type="text" name="captcha" lay-verify="required" autocomplete="off" placeholder="验证码" class="layui-input" style="width:45%;float: left;margin-right:5px;"><img src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>?seed='+Math.random()" height="37" id="captcha" />
                            </div>
                            <div class="layui-form-item">
                                <div class="kit-pull-left kit-login-remember">
                                    <input type="checkbox" value="true" lay-skin="primary" title="记住帐号?">
                                </div>
